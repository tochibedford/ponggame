...
void simulate_game(INPUT *input){
    ...
    if(is_down(BUTTON_UP)) player_pos_y += 0.5f;
    if(is_down(BUTTON_DOWN)) player_pos_y -= 0.5f;
    if(is_down(BUTTON_LEFT)) player_pos_x -= 0.5f;
    if(is_down(BUTTON_RIGHT)) player_pos_x += 0.5f;
